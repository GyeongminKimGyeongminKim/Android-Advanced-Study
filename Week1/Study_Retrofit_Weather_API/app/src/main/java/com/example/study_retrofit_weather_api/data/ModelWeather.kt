package com.example.study_retrofit_weather_api.data
...
data class ITEM(val baseData: Int, val baseTime: Int, val category : String, val fcstDate : String, val fcstTime : String, val fcstValue : String)}
