package com.example.study_immortal_service
...
import com.example.study_immortal_service.GpsData.isServiceRunning
...
class GpsService : Service() {
    ...
    // 서비스 바인드 시, 호출되는 메서드지만, 바인드하지 않음으로 null을 반환
